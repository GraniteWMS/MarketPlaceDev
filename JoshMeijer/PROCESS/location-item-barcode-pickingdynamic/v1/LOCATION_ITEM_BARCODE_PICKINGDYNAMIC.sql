...
GO
INSERT INTO [ProcessStep] ([Name], [Description], [ProcessIndex], [isActive], [Required], [DefaultValue], [NextIndex], [Process], [PreScript], [WebTemplate])
VALUES('TrackingEntity', 'From Location', 2, 'True', 'True', '', 3, 'LOCATION_ITEM_BARCODE_PICKINGDYNAMIC', 'PrescriptPickingDynamic_LOC_MITrackingEntity', 'af53f48a-fd76-53d2-a40d-07a66f51fdb4')
GO
INSERT INTO [ProcessStep] ([Name],[Description],[ProcessIndex],[isActive],[Required],[DefaultValue], [NextIndex],[Process],[PreScript],[WebTemplate]) 
