CREATE PROCEDURE [dbo].[Prescript_Example_SendEmailWithExcelAttachment] (
...
SET @ConsumablesExport = dbo.email_CreateExcelAttachment('CustomView_MasterItem', 'CSV')              
SET @ConsumablesExport = dbo.email_AddExcelAttachmentFilter(@ConsumablesExport, 'Category', 'Equal', 'CONSUMABLE') 
SET @ConsumablesExport = dbo.email_AddExcelAttachmentOrderBy(@ConsumablesExport, 'Description', 'ASC')             
SET @excelAttachments = dbo.email_AddExcelAttachment(@excelAttachments, @ConsumablesExport)                     
